...
namespace LocalitiesManager.Data.Migrations
{
    ...
    [Migration("20230813141516_AddedOwnersSeed")]
    partial class AddedOwnersSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LocalitiesManager.Data.Entities.Locality", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2023, 8, 13, 14, 15, 16, 390, DateTimeKind.Utc).AddTicks(6040),
                            LocalityTypeId = 1L,
                            Name = "Красноярск"
                        },
                        new
                        {
                            Id = 2L,
                            CreatedAt = new DateTime(2023, 8, 13, 14, 15, 16, 390, DateTimeKind.Utc).AddTicks(6050),
                            LocalityTypeId = 1L,
                            Name = "Ачинск"
                        },
                        new
            ...
            modelBuilder.Entity("LocalitiesManager.Data.Entities.LocalityType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2023, 8, 13, 14, 15, 16, 390, DateTimeKind.Utc).AddTicks(5960),
                            Name = "Город",
                            Prefix = "г."
                        },
                        new
                        ...
                        {
                            Id = 6L,
                            CreatedAt = new DateTime(2023, 8, 13, 14, 15, 16, 390, DateTimeKind.Utc).AddTicks(5970),
            ...
            modelBuilder.Entity("LocalitiesManager.Data.Entities.Owner", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2023, 8, 13, 14, 15, 16, 390, DateTimeKind.Utc).AddTicks(6060),
                            FirstName = "Егор",
                            LastName = "Ермаков",
                            Surname = "Дмитриевич"
                        },
                        ...
                        {
                            Id = 2L,
                            CreatedAt = new DateTime(2023, 8, 13, 14, 15, 16, 390, DateTimeKind.Utc).AddTicks(6070),
                            FirstName = "Сергей",
                            LastName = "Пушкин",
                            Surname = "Викторович"
                        });
            ...
            modelBuilder.Entity("LocalitiesManager.Data.Entities.StreetType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2023, 8, 13, 14, 15, 16, 390, DateTimeKind.Utc).AddTicks(6000),
                            Name = "Улица",
                            Prefix = "ул."
                        },
                        new
                        {
                            Id = 2L,
                            CreatedAt = new DateTime(2023, 8, 13, 14, 15, 16, 390, DateTimeKind.Utc).AddTicks(6010),
                            Name = "Переулок",
                            Prefix = "пер."
                        },
                        new
                        ...
                        {
                            Id = 6L,
                            CreatedAt = new DateTime(2023, 8, 13, 14, 15, 16, 390, DateTimeKind.Utc).AddTicks(6020),
                            Name = "Дорога",
                            Prefix = "дор."
                        },
                        new
